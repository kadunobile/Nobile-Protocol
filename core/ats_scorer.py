...
def _analisar_com_llm(
    ...
    system_prompt += (
        ...
        "   - ⚠️ CONTEXTO SÊNIOR: Para perfis sênior/gerência/direção, ferramentas táticas (Outreach, Gong) "
        "SÓ são gaps se o cargo explicitamente requer operação hands-on dessas ferramentas. "
        "Se o candidato tem experiência em gestão estratégica, coordenação de equipes que usam essas ferramentas, "
        "ou equivalentes do mesmo tipo, NÃO marque como gap — adicione aos gaps_falsos_ignorados.\n\n"
